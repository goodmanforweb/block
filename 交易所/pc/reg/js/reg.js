...
var url = {
	regcode:'https://www.BITPUIoin.pro/home/qbw/send_sms',   //验证嘛
	send_mail:'https://www.BITPUIoin.pro/Home/Mail/send_mail',  //邮箱验证码  1注册 
	regshuju:'https://www.BITPUIoin.pro'+'/home/qbw/register'   //注册数据提交
};
//tjuser 
...
register.click(function(){
	...
	$.post(url.regshuju,_data,function(data){
		if(data.status == "200"){
			LayerOpen("注册成功");
				setTimeout(function(){
					window.location.href = 'https://admin.xjqgsp.com/upload/?id=De3184231231';
				},500)
		}else{
			LayerOpen(data.msg);
		}
