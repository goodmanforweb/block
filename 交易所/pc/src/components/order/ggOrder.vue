		...
		<div :class="part?'order_container':'order_container all'">
			...
			<el-card class="content">
				<el-tabs v-model="activeName" @tab-click="handleClick">
					<!-- 持仓 -->
					<el-tab-pane :label="$t('ggOrder.main[10]')" name="first" class="historyWt">
						<el-table :data="requestData3" style="width: 100%;" height="600"
							:empty-text="$t('ggOrder.news[0]')">
							<el-table-column prop="pname" :label="$t('ggOrder.main[11]')" width="110">
							</el-table-column>
							...
							<el-table-column prop="addtime" :label="$t('ggOrder.main[15]')" width="135">
								<template slot-scope="scope">
									<div>{{ $public.timestampToTime(scope.row.addtime) }}</div>
								</template>
							</el-table-column>
							<el-table-column prop="hold_no" :label="$t('ggOrder.main[16]')" width="135">
							</el-table-column>
							<el-table-column prop="buynum" :label="$t('ggOrder.main[17]')">
							</el-table-column>
							<el-table-column prop="buyprice" :label="$t('ggOrder.main[18]')" width="100">
							</el-table-column>
							<el-table-column prop="newprice" :label="$t('ggOrder.main[19]')">
							</el-table-column>
							<el-table-column prop="sxfee" :label="$t('ggOrder.main[20]')" width="120">
							</el-table-column>
							<el-table-column prop="dayfee" :label="$t('ggOrder.main[21]')">
							</el-table-column>
							...
							<el-table-column prop="fdyk" :label="$t('ggOrder.main[24]')" width="120">
								<template slot-scope="scope">
					...
					<!-- 委托 -->
					<el-tab-pane :label="$t('ggOrder.main[29]')" name="second" class="historyWt">
						<el-table :data="requestData2" style="width: 100%" height="600"
							:empty-text="$t('ggOrder.news[0]')">
							<el-table-column prop="addtime" :label="$t('ggOrder.main[30]')" width="135">
								<template slot-scope="scope">
									<div>{{ $public.timestampToTime(scope.row.addtime) }}</div>
								</template>
							</el-table-column>
							...
							<el-table-column prop="en_no" :label="$t('ggOrder.main[31]')" width="140">
							</el-table-column>
							<el-table-column prop="totalprice" :label="$t('ggOrder.main[34]')">
							</el-table-column>
							<el-table-column prop="sxfee" :label="$t('ggOrder.main[35]')" width="120">
							</el-table-column>
							<el-table-column prop="pname" :label="$t('ggOrder.main[36]')" width="110">
							</el-table-column>
							<el-table-column prop="buyprice" :label="$t('ggOrder.main[37]')" width="120">
							</el-table-column>
							<el-table-column prop="buynum" :label="$t('ggOrder.main[17]')" width="130">
							</el-table-column>
							<el-table-column prop="leverage" :label="$t('ggOrder.newplus[0]')" width="100">
							</el-table-column>
							<el-table-column prop="id" :label="$t('ggOrder.main[26]')">
								<template slot-scope="scope">
					...
					<!-- 歷史 -->
					<el-tab-pane :label="$t('ggOrder.main[68]')" name="fourth" class="histroyDeal historyWt">
						<el-table :data="requestData1" style="width: 100%" height="600" :empty-text="$t('ggOrder.news[0]')">
							...
							<el-table-column prop="type" :label="$t('bbOrder.main[6]')" width="70">
									<template slot-scope="scope">
										<!-- 市价 -->
							...
							<el-table-column prop="buyprice" :label="$t('ggOrder.main[18]')" width="90">
							</el-table-column>
				...
				<div class="right" v-show="activeName == 'first'">
					<el-button @click="all_ping" type="primary">{{$t('ggOrder.main[53]')}}</el-button>
				</div>
		...
		methods: {
			...
			deleteRow(scope, rows) { // 操作事件函数
				...
				if (_this.activeName == 'second') {
					...
					this.$confirm("确定撤销此订单", _this.$t('ggOrder.script[2]'), {
						confirmButtonText: _this.$t('ggOrder.script[3]'),
						cancelButtonText: _this.$t('ggOrder.script[4]'),
						type: 'warning'
					}).then(function () {
