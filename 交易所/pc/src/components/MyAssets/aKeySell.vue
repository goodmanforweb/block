...
<template>
  <div class="aKeySell">
    <div class="oneKey_title">
      <div class="title">
        <h2>{{$t('BITPUIBi.cb[13]')}}</h2>
        <h6>{{$t('BITPUIBi.cb[14]')}}</h6>
      </div>
      <div class="info">
        <div class="item">
          <h6>{{$t('BITPUIBi.cb[15]')}}</h6>
          <p>
            {{$t('BITPUIBi.cb[4]')}}:
        ...
        <!-- <div class="item">
          ...
          <p>
            {{Data.shop_num}} {{$t('BITPUIBi.cb[6]')}}:
            <span class="saveYourLife">{{$t('BITPUIBi.cb[7]')}}</span>
          </p>
        </div> -->
      </div>
    </div>
