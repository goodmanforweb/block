...
<template>
  <div class="ti_bit_wrapper">
    ...
    <div class="ti_bit_container">
      <table></table>
      <div class="titles">
        <h2 style="padding-left: 30px">{{$t('BITPUIBi.tb[0]')}} >{{$t('tiBit.header[0]')}}</h2>
        <span @click="$router.push('/aKeySell')" class="right">{{$t('BITPUIBi.cb[13]')}}</span>
      </div>
      <div class="ti_top">
        <div class="ti_bit_inner">
          ...
          >
            ...
            <el-form-item :label="$t('tiBit.main[2]')" prop="num" class="highMoney">
              ...
              ></el-input>
              <el-input v-model.number="ruleForm.num" :placeholder="$t('BITPUIBi.tb[3]')" v-else></el-input>
              <span>{{$t('BITPUIBi.tb[1]')}} {{biNum}}</span>
            </el-form-item>
            <el-form-item :label="$t('BITPUIBi.tb[2]')" prop="pass">
              <el-input type="password" v-model="ruleForm.pass" :placeholder="$t('BITPUIBi.tb[4]')"></el-input>
            </el-form-item>
            <div class="code_warp">
    ...
    <el-dialog :title="$t('tiBit.main[12]')" :visible.sync="dialogFormVisible">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="dialogFormVisible = false">{{$t('tiBit.main[14]')}}</el-button>
