    ...
    <template> 
        <div class="oneKey">
            <div class="oneKey_title">
                <div class="title">
                    <h2>{{$t('BITPUIBi.cb[1]')}}</h2>
                    <h6>{{$t('BITPUIBi.cb[2]')}}</h6>
                </div>
                <div class="info">
                    <div class="item">
                        <h6>{{$t('BITPUIBi.cb[3]')}}</h6>
                        <p>
                                {{$t('BITPUIBi.cb[4]')}}:<span class="green">{{Data.price}}CNY</span>
                        </p>
                    </div>
                    <div class="river"></div>
                    <div class="item">
                            <h6> {{$t('BITPUIBi.cb[5]')}}</h6>
                            <p>
                                {{Data.shop_num}} {{$t('BITPUIBi.cb[6]')}}:<span class="saveYourLife"> {{$t('BITPUIBi.cb[7]')}}</span>
                            </p>
                        </div>
                </div>
            </div>
            <div class="oneKey_form">
                    <el-form :model="buyData" label-position="top" ref="form" label-width="100px" class="from">
                            <el-form-item
                              :label="$t('BITPUIBi.cb[8]')"
                              prop="total_price"
                              :rules="[{ required: true, message: $t('BITPUIBi.cb[9]'), trigger: 'blur' },]"
                            >
                              <el-input class="iptPrice" type="age" :placeholder="`${$t('BITPUIBi.cb[10]')}${min} ${$t('BITPUIBi.cb[11]')}，${$t('BITPUIBi.cb[12]')}${max}${$t('BITPUIBi.cb[11]')}`" v-model="buyData.total_price" auto-complete="off"></el-input>
                            </el-form-item>
                            <el-form-item
