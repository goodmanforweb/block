<template>
	<div class="security_main">
		...
		<div class="information">
			...
			<div class="information_cont">
				<ul class="lis_warp">
					...
					<!-- 资金密码 -->
					<li class="lis">
						<span class="name">{{$t('zeusChange.main[0]')}}</span>
			...
			<div class="authentication_cont">
				<ul class="lis_warp">
					...
					<!-- <li class="lis">
						...
						<!-- <span class="info">{{$t('zeusChange.main[1]')}}</span> -->
					<!-- </li> -->
					<!-- 手机号 -->
					<li class="lis">
					...
					<li class="lis">
						...
						<a href="javascript:;" class="modify"  v-if="userData.status !=3 &&  userData.status !=2" @click="change_router('/senior')"><span>{{$t('security.tip[5]')}}</span></a>
						<a href="javascript:;" class="modify"  v-if="userData.status ==3"><span>{{$t('security.tip[3]')}}</span></a>
						<!-- <a href="javascript:;" class="modify"  v-if="userData.status ==3"><span>{{$t('security.tip[3]')}}</span></a> -->
						<a href="javascript:;" class="modify"  v-if="userData.status ==2"><span>{{$t('identity.main[3]')}}</span></a>


						<!-- <a href="javascript:;" class="modify"  v-if="userData.status !=3" @click="change_router('/senior')"><span>{{$t('security.tip[6]')}}</span></a> -->
		...
		<el-dialog :title="$t('security.two[7]')"  width='660px' :visible.sync="dialogVisible" class="opengoogle" center>
			<el-form  label-position="top" :model="form1">
				<el-form-item :label="$t('security.two[3]')" :label-width="formLabelWidth">
