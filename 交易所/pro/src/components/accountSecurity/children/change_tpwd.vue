		...
		<div class="form_warp tpwd">
			<div class="form_cont">
				<el-form :label-position="labelPosition" :model="userData" status-icon :rules="rules2" ref="userData" label-width="100px" class="demo-ruleForm">
					...
					<div class="code_warp">
						<el-form-item :label='$t("login.main[3]")' prop="code">
					...
					<el-form-item :label='$t("change_tpwd.verification[5]")' prop="tpwd">
						<el-input type="password" v-model="userData.tpwd" auto-complete="off" :placeholder="$t('zeusChange.zjPwd[1]')"></el-input>
					</el-form-item>
					<el-form-item :label='$t("change_tpwd.verification[6]")' prop="tpwd1">
						<el-input type="password" v-model="userData.tpwd1" auto-complete="off" :placeholder="$t('zeusChange.zjPwd[2]')"></el-input>
					</el-form-item>
					<el-form-item>
