<style lang=less>
	...
	/* 单独页面单独样式，咨询为抓取过来的带样式，需要过滤下，公告为后台编写的，防止相互影响 */
	@import './ggnoticeDetails.less';
...
<template lang="html">
	<div class="notice_details_wrapper">
		...
		<div class="details_container">
			<!-- 系统公告标题 -->
			<h1 v-if='type == 2' class="content_title">
				{{data.title}}
			</h1>
			<!-- 行情标题 -->
			...
			<!-- 公告时间 -->
			<h4 v-if='type == 2' class="content_time">{{Time}}</h4>
			<!-- 标题时间 -->
