<style lang=less>
	...
	.messageBox-prompt-test .el-message-box__header,
	.messageBox-prompt-test .el-message-box__content,
	.messageBox-prompt-test .el-message-box__wrapper .el-message-box {
	...
	.messageBox-prompt-test .el-message-box p,
	.messageBox-prompt-test .el-message-box__title span {
		color: #fff !important;
	}

	.messageBox-prompt-test .el-message-box__btns{
		display: flex;
		justify-content: space-between;


	}
	.messageBox-prompt-test .el-message-box__btns button{
		width: 150px;
	}
	.messageBox-prompt-test .el-message-box__btns button:nth-child(2){
		background: #2A64F3;
		border-color: #2A64F3;
	}
	.messageBox-prompt-test .el-message-box__btns button:nth-child(1):hover{
		background: #ffffff;
		color: #606266;
		border-color: #DCDFE6;
	}
	.Sellout .messageBox-prompt-test .el-message-box__header span{
		color: #fff !important;
	}
	p.fr.canWall {
	...
	<div class="Sellout">
		<el-form ref="form" :model="form" size="mini" label-width="40px" label-position="left">
			...
			<router-link v-else to="/login">
				<el-button type="danger" size="small" :loading="loadingsellout">
					{{$t('sellout.sell[7]')}}
				</el-button>
			</router-link>
			<!-- </el-form-item> -->
		...
		watch: {
			...
			"sendData.buynum": function (val, oval) {
				...
				if (!val) {
					...
					_this.sendData.buynum = val.toString().replace(/[^[1-9]\d]/g, '');
