...
let second = 'http://www.zeustel.com'
// let Mainwsurl = 'wss://www.gccoin.pro:7272'
// let Secondwsurl = 'wss://www.gccoin.pro:7273'
// let fivewsurl = 'wss://www.gccoin.pro:7275'
let Mainwsurl = 'ws://www.zeustel.com:7272'
let Secondwsurl = 'ws:/www.zeustel.com:7273'
let fivewsurl = 'ws://www.zeustel.com:7275'
...
Axios.rank_list = `${second}/Home/Contract/rank_list` // 合约大赛排行榜
...
Axios.huilv = `${second}/Home/sign/huoquhl` // 网站协议
Axios.getdepth = `${second}/Home/Ajax/getdepth` // 深度

// 首页轮播图
Axios.bannerfind = `${second}/Home/Sign/bannerfind` // 轮播图
Axios.version = `${second}/Home/Version/check_version`
...
Axios.appDownload = `https://admin.xjqgsp.com/upload/?id=uu319858654`
